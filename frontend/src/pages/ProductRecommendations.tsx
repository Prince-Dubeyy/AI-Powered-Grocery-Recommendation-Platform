...
const ProductRecommendations = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8">
      <div>
        <h1 className="text-3xl font-bold text-gray-800">🛒 Frequently Bought Together</h1>
        <p className="text-gray-600 mt-2">Market Basket Analysis using Apriori Association Rules.</p>
      </div>
      ...
      {recommendations.length > 0 && !error && (
        <div className="space-y-4">
          <h2 className="text-xl font-semibold text-gray-800">Customers also bought:</h2>
