  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-gray-600 mt-2">Wondering why certain products are recommended together? Let our Gemini AI explain the shopping patterns!</p>
      </div>
      ...
      {recommendations.length > 0 && !error && (
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          <h2 className="text-xl font-semibold text-gray-800 mb-4">Shopping Pattern</h2>
          
          <div className="flex flex-col md:flex-row items-center gap-6 bg-gray-50 p-6 rounded-lg mb-6">
            <div className="flex-1 text-center font-semibold text-lg text-gray-700 border-2 border-dashed border-gray-300 p-4 rounded-lg bg-white">
              {productName}
            </div>
